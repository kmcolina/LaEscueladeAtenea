...
@Component({
  selector: 'app-check-box-skill',
  templateUrl: './check-box-skill.component.html',
  styleUrls: ['./check-box-skill.component.scss'],
})
export class CheckBoxSkillComponent implements OnInit {
  form: FormGroup;
  skillsAvaible = [
    {
